...
* Blown up ontologies experiments
  ...
  You can find on this [[https://github.com/mburon/guarded-saturation-experiments/tree/vldb22][repository]] the input files used to run the experiments and the resulting statistics files from which the following results come from. You can also visit the [[https://krr-oxford.github.io/Guarded-saturation/][website of our system GSat]].
