...
** Winning case summary
  ...
  #+BEGIN_SRC ipython :results drawer  :session mysession :ipyfile plots/kept-times.png
    win_indexes_10 = win_collect(['GSAT', 'SK', 'HYPER', 'KAON2'], 10)
    win_indexes_10_similar = [ 13, 16, 17, 18, 19, 151, 283, 368, 369, 370, 389, 398, 415, 417, 426, 532, 574, 575, 595, 597, 666, 676, 772, 788, 789]
    interesting_indexes = [ 353, 377, 632, 394, 454, 498, 553, 719, 729,  ]
